...
class ProjectManager {
    constructor() {
        ...
        this.getProjectNames = (projectNamesTyped) => {
            return (projectNamesTyped === null || projectNamesTyped === void 0 ? void 0 : projectNamesTyped.length) === 0 ? Object.keys(this.allProjects) : projectNamesTyped;
        };
        this.generateConfigFolder = () => {
            (0, child_process_1.execSync)(`mkdir -p ${constants_1.constants.CONFIG_FOLDER}`, { stdio: 'inherit' });
        };
        this.transformProjectList = (rawProjects, props) => {
            return Object.keys(rawProjects).reduce((accumulator, currentValue) => (Object.assign(Object.assign({}, accumulator), { [currentValue]: new project_1.Project(currentValue, rawProjects[currentValue], props) })), {});
        };
        ...
        this.loadProjectsFromFile = () => {
            ...
            const _a = JSON.parse(data), { runnableProjects, noRunnableProjects } = _a, props = __rest(_a, ["runnableProjects", "noRunnableProjects"]);
